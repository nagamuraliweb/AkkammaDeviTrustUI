...
export const PAYMENTTYPELIST = [{ option: 'Cash', value: 'Cash' },
{ option: 'Gpay/PhonePe', value: 'Gpay/PhonePe' },
{ option: 'Bank NEFT/RTGS', value: 'Bank NEFT/RTGS' }];

export const MONTHSLIST = [{ option: 'Chithirai', value: 'Chithirai' },
{ option: 'Vaigashi', value: 'Vaigashi' },
{ option: 'Aani', value: 'Aani' },
{ option: 'Aadi', value: 'Aadi' },
{ option: 'Aavani', value: 'Aavani' },
{ option: 'Protashi', value: 'Protashi' },
{ option: 'Ippashi', value: 'Ippashi' },
{ option: 'Karthigai', value: 'Karthigai' },
{ option: 'Margazhi', value: 'Margazhi' },
{ option: 'Thai', value: 'Thai' },
{ option: 'Maasi', value: 'Maasi' },
{ option: 'Panguni', value: 'Panguni' }];